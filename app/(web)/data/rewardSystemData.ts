export const rewardSystemData = {
  ...
  scope: {
    ...
    exclusions:
      "This policy does not cover external contractors unless they are EMT members acting in a vendor capacity (e.g., equity conversion for project costs).",
  },
  equity: {
    framework:
      "Equity serves as a long-term incentive, reflecting shared ownership in RikeSD's success. Allocations are based on roles, contributions, and project involvement, with caps to maintain balance.",
    board: {
      base: "0.5% per member upon joining.",
      performance:
        "Up to 0.25% annually for strategic contributions (e.g., securing partnerships or funding).",
      cap: "Total equity per member not to exceed 2%.",
    },
    emt: {
      base: "1% per member upon joining.",
      projectChampion:
        "0.5–1% for leading specific projects, awarded upon milestone achievement.",
      performance: "Up to 0.5% annually for operational outcomes.",
      cap: "Total equity per member not to exceed 5%.",
    },
    conversion:
      "For EMT members who are vendors (e.g., providing software development services), up to 50% of project costs may be converted into an equity bond. Example: For a 19.2 million NGN project, 9.6 million NGN paid in cash, with the remainder converted to equity as a tech partnership stake in projects like KEIA.",
    vesting: {
      table: [
        {
          group: "Board",
          type: "Base",
          period: "2 years",
          details: "25% at 6 months, then monthly pro-rata",
          cliff: "6 months",
          triggers:
            "Major funding round; project success (e.g., KEIA incubating 10 startups)",
        },
        {
          group: "Board",
          type: "Performance-Based",
          period: "1 year",
          details: "Quarterly pro-rata",
          cliff: "None",
          triggers: "Board-approved strategic milestones",
        },
        {
          group: "EMT",
          type: "Base",
          ...
          cliff: "1 year",
          triggers:
            "Project launch (e.g., AroFarmer transforming 100 urban spaces)",
        },
        {
          group: "EMT",
          type: "Project Champion Bonus",
          period: "2 years",
          details: "50% at 1 year, remainder monthly",
          cliff: "1 year",
          triggers:
            "Milestone achievement (e.g., Skillnovate reaching 5,000 users)",
        },
        {
          group: "EMT",
          type: "Performance-Based",
          ...
          details: "Quarterly pro-rata",
          cliff: "None",
          triggers: "Annual performance review",
        },
      ],
    },
    forfeiture:
      "Unvested equity is forfeited upon voluntary departure or termination for cause.",
  ...
  incentives: {
    ...
    emt: {
      ...
      projectCriteria: {
        skillnovate:
          "Launching certification programs; achieving 10,000 active users; 80% completion rate in training sessions.",
        keia: "Incubating 5 startups; securing investor funding (>2 million NGN per startup); marketplace access for 10 products.",
        rikeMarketplace:
          "Onboarding 100 research outputs; generating 1 million NGN in sales; integrating with AroFarmer Initiative.",
        arofarmer:
          "Matching 50 landowners with growers; transforming 50 urban spaces; generating 500,000 NGN in community income.",
        patchAfrica:
          "Implementing Waste for Meal Program in 5 communities; securing carbon credits for 10 universities; reducing emissions by 20% in pilot areas.",
      },
      development:
        "Access to Skillnovate courses or external certifications (value up to 500,000 NGN).",
      recognition: '"Project Champion" awards at RikeSD events.',
    },
    disbursement:
      "Bonuses paid quarterly upon milestone verification. Criteria evaluated using KPIs (e.g., user metrics, revenue, impact reports).",
  },
  review: {
    committee:
      "Composed of 2 Board members, 2 EMT representatives, and 1 neutral advisor. Meets quarterly.",
    annual:
      "Comprehensive assessment in Q4, including: Evaluation of contributions via self-assessments, peer reviews, and KPI data. Adjustments to equity caps, bonus amounts, or criteria based on organizational performance and feedback.",
    ...
    documentation:
      "All reviews recorded and shared transparently with stakeholders.",
  },
  implementation: [
  ...
  compliance:
    "All rewards must comply with applicable laws (e.g., Nigerian tax regulations). Conflicts of interest must be disclosed. Violations may result in forfeiture of rewards.",
  appendix: {
    glossary: [
      {
        term: "Equity Bond",
        def: "Convertible equity tied to project contributions.",
      },
      {
        term: "Milestone",
        def: "Measurable achievement (e.g., user growth, funding secured).",
      },
      { term: "Vesting", def: "Gradual ownership transfer of equity." },
    ],
  },
  signed: "Signed: EMT Member & BOD Date: September 24, 2025",
};
